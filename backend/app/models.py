from sqlalchemy import Column, String, Float, Integer, Date, ForeignKey, Numeric
...
class Campaign(Base):
    ...
    universo_zona_metro = Column(Numeric(20, 0))
    impactos_personas = Column(Numeric(20, 0))
    impactos_vehiculos = Column(Numeric(20, 0))
    frecuencia_calculada = Column(Float)
    frecuencia_promedio = Column(Float)
    alcance = Column(Numeric(20, 2))
...
class CampaignPeriod(Base):
    ...
    impactos_periodo_personas = Column(Numeric(20, 0))
    impactos_periodo_vehiculos = Column(Numeric(20, 0))
...
class CampaignSite(Base):
    ...
    impactos_catorcenal = Column(Numeric(20, 0))
    impactos_mensuales = Column(Numeric(20, 0))
